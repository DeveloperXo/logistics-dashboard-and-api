...
const CreatePtlBooking = () => {
  ...
  useEffect(() => {
    ...
    setShipperNamesOpt([{ value: '', label: 'Select Shipper Name' }])
    setPickupLocationsOpt([{ value: '', label: 'Select Pickup Location' }])
  }, [])
  ...
  const handleFormDataOnChange = (e) => {
    ...
    setFormData((prev) => ({
      ...prev,
      [name]:
        type == 'checkbox' ? (checked ? true : false) : type == 'number' ? Number(value) : value,
    }))
  }
          ...
          <CCard className="mb-4">
            ...
            <CCardBody>
              ...
              <div className="d-md-flex justify-content-md-end">
                <CButton size="sm" color="primary" onClick={addDimension}>
                  + Add
                </CButton>
              </div>
                ...
                >
                  <div className="flex-fill">
                    <CFormInput
                      ...
                      id={`${index}-eWayBillNo`}
                      onChange={(e) =>
                        handleShipperInvoiceOnChange(index, 'eWayBillNo', e.target.value, e)
                      }
                  ...
                  <div className="flex-fill">
                    <CFormInput
                      ...
                      id={`${index}-invoiceNo`}
                      onChange={(e) =>
                        handleShipperInvoiceOnChange(index, 'invoiceNo', e.target.value, e)
                      }
                  ...
                  <div className="flex-fill">
                    <CFormInput
                      ...
                      onChange={(e) =>
                        handleShipperInvoiceOnChange(index, 'invoiceAmount', e.target.value, e)
                      }
                  ...
                  <div className="flex-fill">
                    <CFormInput
                      ...
                      onChange={(e) =>
                        handleShipperInvoiceOnChange(index, 'invoiceDate', e.target.value, e)
                      }
                  ...
                  <div className="flex-fill">
                    <CFormInput
                      ...
                      id={`${index}-attachment`}
                      onChange={(e) =>
                        handleShipperInvoiceOnChange(index, 'attachment', e.target.value, e)
                      }
                      type="file"
                      required
                    />
                  </div>
                  {
                    <CButton
                      size="sm"
                      disabled={index === 0}
                      onClick={() => removeShipperInvoice(index)}
                      className="mt-4"
                      color="warning"
                    >
                      <CIcon icon={cilX} />
              ...
              <div className="d-md-flex justify-content-between">
                ...
                <CButton size="sm" color="primary" onClick={addShipperInvoice}>
                  + Add
                </CButton>
              </div>
              ...
              <p className="text-muted">
                <b>
                  <i>Delivery Location Information:</i>
                </b>
              </p>
              <div className="d-flex justify-content-start align-items-center gap-3 mb-3">
                <div className="flex-fill">
            ...
            <CCardFooter>
              <div className="d-flex justify-content-between">
                <CButton color="light" onClick={() => navigate('/ptl/bookings')}>
                  Cancel
                </CButton>
                <CButton type="submit" disabled={isLoading} color="primary">
                  {isLoading ? 'Processing...' : !id ? 'Create' : 'Update'}
                </CButton>
              </div>
            </CCardFooter>
          </CCard>
